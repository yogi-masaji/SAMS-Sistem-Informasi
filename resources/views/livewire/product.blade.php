<div style="padding-top: 50px">
    <div class="row">
        <div class="col-md-8">
            <div class="card">
            <div class="card-body">
                <h2 class="font-weight-bold mb-3">List makanan Minuman</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button wire:click="remove({{$product->id}})" type="submit" class="btn btn-danger btn-block mt-2">Delete</button>
                            </td>
